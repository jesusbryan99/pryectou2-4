                    ...
                    <form className="imageupload__commentAssign">
                        ...
                        <div className="imageupload__secondSectionModal">
                            <Avatar
                                ...
                                alt=""
                            />
                            <input type="text" onChange={(e) => setCaption(e.target.value)} onClick={handleOpen} placeholder={`${username} ¿En que estas pensando?`} />
                        </div>
                        <hr />
                        ...
                        <div className="imageupload__feedModal">
                            ...
                            <h3>News Feed</h3>
                            <br />
                            <h2 className={`imageText ${image && 'show'}`}>La imagen se agrega y se mostrará después de hacer clic en el botón Publicar</h2>
            ...
            <div className="imageupload__container">
                ...
                <div className="imageupload__secondSection">
                    <Avatar
                        ...
                        alt=""
                    />
                    <input type="text" onClick={handleOpen} placeholder={`${username}¿Que estas pensado?`} />
                </div>
                <hr />
